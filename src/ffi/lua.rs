...
use libc::{c_double, c_int, c_schar, c_uchar, c_void, ptrdiff_t, size_t};
use std::ptr;
...
pub type lua_Reader = Option<
  unsafe extern "C" fn(L: *mut lua_State, ud: *mut c_void, sz: *mut size_t) -> *const c_uchar,
>;
...
extern "C" {
  ...
  pub fn lua_typename(L: *mut lua_State, idx: c_int) -> *const c_schar;
